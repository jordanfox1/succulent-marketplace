...
Having a highly specific purpose and user base for this application, allows for additional functionality which is directly linked to that purpose, for example, built in succulent descriptions, names or stock images.
...
Users can create, update and delete a succulent listing. These listings are displayed to other users. This includes the ability to upload images and write descriptions
Users can search for a succulent by name or by category
Users make an email request for the succulents of other users
